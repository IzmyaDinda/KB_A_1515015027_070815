...
cek_bulan_ulang_tahun(Bulan_ini, Tanggal),%ulang tahun diketahui dari bulan dan tanggal
...
daftar_telepon(orang(lidya,widyawati),"555-5653",tanggal_lahir(16,jul,1981)).	     %terdiri dari nama pertama dan kedua, no telepon dan tanggal lahir
daftar_telepon(orang(yusida,andriani),"767-2223",tanggal_lahir(10,aug,1981)).	     %tanggal lahir terdiri dari hari, bulan dan tahun
...
konversi_bulan(jun, 6).		%konversi nama bulan ke urutan bulan
